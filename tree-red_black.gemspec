...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Pure-Ruby implemention of a Red-Black tree, which is a self-balancing binary search tree with O(log n) search, insert and delete operations.}
